...
?>">
			<?php 
\esc_html_e('Set image', 'octolize-canada-post-shipping');
?>
		</a>
...
?>" href="#">
			<?php 
\esc_html_e('Remove image', 'octolize-canada-post-shipping');
?>
		</a>
	</p>
</div>
...
?>' ),
		...
		addImgLink.on( 'click', function ( event ) {
			...
			frame = wp.media( {
				title: "<?php 
\esc_html_e('Select or Upload Media', 'octolize-canada-post-shipping');
?>",
				button: {
					text: "<?php 
\esc_html_e('Use this media', 'octolize-canada-post-shipping');
?>"
				},
				library: {
					type: ['image']
