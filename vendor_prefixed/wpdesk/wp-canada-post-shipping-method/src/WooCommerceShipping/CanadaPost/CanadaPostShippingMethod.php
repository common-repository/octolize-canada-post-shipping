 ...
 */
class CanadaPostShippingMethod extends ShippingMethod implements ShippingMethod\HasFreeShipping, ShippingMethod\HasRateCache
{
    /**
     * Supports.
     *
    ...
    {
        $canada_post_settings_definition = new CanadaPostSettingsDefinitionWooCommerce($this->form_fields);
    ...
    {
        return new CanadaPostMetaDataBuilder($this);
    }
    /**
    ...
    public function admin_options()
    {
        if ($this->instance_id) {
            ...
            $this->instance_form_fields[CanadaPostSettingsDefinition::SERVICES]['options'] = $services_options;
        }
    ...
    {
        return 'yes' === $this->get_option(CanadaPostSettingsDefinition::CUSTOM_ORIGIN, 'no');
    }
    /**
