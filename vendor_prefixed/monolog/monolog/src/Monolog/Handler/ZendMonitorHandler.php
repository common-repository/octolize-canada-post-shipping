...
class ZendMonitorHandler extends AbstractProcessingHandler
{
    ...
    public function __construct($level = Logger::DEBUG, bool $bubble = \true)
    {
        ...
        $this->levelMap = [Logger::DEBUG => \OctolizeShippingCanadaPostVendor\ZEND_MONITOR_EVENT_SEVERITY_INFO, Logger::INFO => \OctolizeShippingCanadaPostVendor\ZEND_MONITOR_EVENT_SEVERITY_INFO, Logger::NOTICE => \OctolizeShippingCanadaPostVendor\ZEND_MONITOR_EVENT_SEVERITY_INFO, Logger::WARNING => \OctolizeShippingCanadaPostVendor\ZEND_MONITOR_EVENT_SEVERITY_WARNING, Logger::ERROR => \OctolizeShippingCanadaPostVendor\ZEND_MONITOR_EVENT_SEVERITY_ERROR, Logger::CRITICAL => \OctolizeShippingCanadaPostVendor\ZEND_MONITOR_EVENT_SEVERITY_ERROR, Logger::ALERT => \OctolizeShippingCanadaPostVendor\ZEND_MONITOR_EVENT_SEVERITY_ERROR, Logger::EMERGENCY => \OctolizeShippingCanadaPostVendor\ZEND_MONITOR_EVENT_SEVERITY_ERROR];
