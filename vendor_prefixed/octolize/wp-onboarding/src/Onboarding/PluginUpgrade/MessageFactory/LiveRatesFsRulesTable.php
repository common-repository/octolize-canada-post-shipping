...
namespace OctolizeShippingCanadaPostVendor\Octolize\Onboarding\PluginUpgrade\MessageFactory;

use OctolizeShippingCanadaPostVendor\Octolize\Onboarding\PluginUpgrade\PluginUpgradeMessage;
class LiveRatesFsRulesTable
{
    public function create_message(string $plugin_version, string $plugin_url)
    {
        return new PluginUpgradeMessage($plugin_version, trailingslashit($plugin_url) . 'vendor_prefixed/octolize/wp-onboarding/assets/images/icon-complex-solution.svg', __('We\'ve added integration with Flexible Shipping Table Rate', 'octolize-canada-post-shipping'), sprintf(
